import { EstadosCompra, EstadoType } from '@/types/types';
import { Flex, Text, useColorModeValue } from '@chakra-ui/react';
import React from 'react';

const CompraModalTopPart = ({ estado }: { estado: EstadoType }) => {
  const nextEstado = EstadosCompra[EstadosCompra.indexOf(estado) + 1];
  const firstText = {
...
export default CompraModalTopPart;
